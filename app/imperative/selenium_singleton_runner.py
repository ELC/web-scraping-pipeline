...
from ..selenium_based import utils


old_decorator = utils.get_driver
utils.get_driver = utils.get_singleton_driver
close_driver = utils.close_singleton_driver
...
def runner():
    ...
    profiles_with_coordinates = [process(profile) for profile in profiles]
